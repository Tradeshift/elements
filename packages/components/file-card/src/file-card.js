...
customElementDefineHelper(
	...
	class extends TSElement {
				...
				<span class="${classNames.FILE_ICON_WRAPPER}">
					...
					>
						<g id="Symbols" stroke-width="1">
							<g id="card/5.-File-card/mouseover" transform="translate(-9.000000, -9.000000)">
								<g id="5.-File-card">
		...
		render() {
			return html`
				<div ?data-removable="${this.removable}" class="file-card-wrapper state-${this.state}">
