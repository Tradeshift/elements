...
customElementDefineHelper(
	...
	class extends TSElement {
		...
		get dropBox() {
			return html`
				<div class="${classNames.DRAGGABLE_INFO} ${classNames.DROP_BOX}">
					...
					<slot name="${slotNames.DROP_TEXT}">${messages.DROP_FILE}</slot>
				</div>
			`;
		}
			...
			return html`
				...
				>
					<g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g id="card/5.-File-card/drag-and-drop" transform="translate(-113.000000, -22.000000)" fill="#00B0FF">
							<g id="5.-File-card">
								<g id="Content" transform="translate(113.000000, 19.000000)">
									<g id="upload-icon" transform="translate(0.000000, 3.000000)">
										<path
		...
		get helpText() {
			...
			return html`
				<ts-help-text
					class="${this.classNames.HELP_TEXT}"
